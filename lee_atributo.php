<?php
  ...
  if ( in_array($srv, $capasServicio, false) ){ 
    ...
    $valret ='
    <p class="h2 text-primary">' . $datos['actividad'] . '</p>
    <p class="h5">' . $datos['calle'] . ' ' . $datos['altura'] . ' - ' . $datos['barrio'] . '</p>
    ...
    $valret = '<div>Sin dato</div>';

  }

  $valret .= '<div style="border-top: solid 1px #7c7c7c; margin-top: 5px;">Dir. Gral. de S.I.G. - Municipalidad de Corrientes</div>';
